...
parser.add_argument("--alpha", default=0.13, type=float, help="Learning rate.")
parser.add_argument("--epsilon", default=0.08, type=float, help="Exploration factor.")
parser.add_argument("--gamma", default=1, type=float, help="Discounting factor.")
parser.add_argument("--episodes", default=1000, type=int, help="Number of episodes.")
parser.add_argument("--n", default=5, type=int, help="Number of steps in n-step TD algorithm.")
parser.add_argument("--off_policy", default=False, type=bool, help="Whether to use off or on policy.")
parser.add_argument("--expert_frequency", default=3, type=int, help="How often to use expert trajectory to train.")
...
def main(env: wrappers.EvaluationEnv, args: argparse.Namespace) -> None:
    ...
    # Train
        ...
        for j in trange(args.episodes):
            ...
            # Use a trajectory generated by an expert every few episodes (default 3)
            if j % args.expert_frequency == 0:
                use_expert = True
            ...
            if not use_expert:
                ...
                # Generate a starting point for n-step tree backup
                ...
                # Generate an expert trajectory to learn from
