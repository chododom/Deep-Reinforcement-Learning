...
parser.add_argument("--model_path", default='ppo_model_572.h5', type=str, help="Path to a pre-trained model.")
...
def main(env: wrappers.EvaluationEnv, args: argparse.Namespace) -> None:
    ...
    try:
        while training:
            ...
            # Maybe somehow vectorize this if too slow?
            ...
            if iteration % args.evaluate_each == 0:
                ...
                if scores_avg > max(current_best, 450):
                    current_best = scores_avg
                    model_name = f'ppo_model_{int(current_best)}.h5'
                    network.save_weights(model_name)
